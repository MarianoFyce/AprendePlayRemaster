...
import com.example.aprende_play.databinding.ActivityRegistrarninosBinding;
...
public class Registrarninos extends AppCompatActivity {
    private ActivityRegistrarninosBinding binding;
    private  String encodedImage;
    private PreferenceManager preferenceManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityRegistrarninosBinding.inflate(getLayoutInflater());
