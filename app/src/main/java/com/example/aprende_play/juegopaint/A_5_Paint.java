...
public class A_5_Paint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a5_paint);

        ////////////parte del video
        videoView = findViewById(R.id.videoocho);

        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.cincoo));
        ...
        stroke = (ImageButton) findViewById(R.id.btn_stroke3);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // name of the imagen
                cv.put(MediaStore.Images.Media.DISPLAY_NAME, "Mis_números.png");
                ...
                try {
                    ...
                    Toast.makeText(A_5_Paint.this,"¡Imagen Guardada!",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
//esta parte de codigo no funciona con esta version de la app
...
*/
    ...
    public void pasavalidar(View view) {
        Intent ob = new Intent(A_5_Paint.this, A_5_Valid.class);
        startActivity(ob);
    }
}