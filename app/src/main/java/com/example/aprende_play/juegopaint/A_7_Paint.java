...
public class A_7_Paint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a7_paint);

        ////////////parte del video
        videoView = findViewById(R.id.videoocho);

        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.sietee));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(A_7_Paint.this,"¡Imagen Guardada!",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
*/
    ...
    public void pasavalidar(View view) {
        Intent ob = new Intent(A_7_Paint.this, A_7_Valid.class);
        startActivity(ob);
    }
}