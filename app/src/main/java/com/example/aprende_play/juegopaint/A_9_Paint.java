...
public class A_9_Paint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a9_paint);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(A_9_Paint.this,"¡Imagen Guardada!",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
*/
    ...
    public void pasavalidar(View view) {
        Intent ob = new Intent(A_9_Paint.this, A_9_Valid.class);
        startActivity(ob);
    }
}