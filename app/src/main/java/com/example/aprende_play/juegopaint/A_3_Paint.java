...
public class A_3_Paint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a3_paint);

        ////////////parte del video
        videoView = findViewById(R.id.videoocho);

        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.tress));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(A_3_Paint.this,"¡Imagen Guardada!",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
*/
    ...
    public void pasavalidar(View view) {
        Intent ob = new Intent(A_3_Paint.this, A_3_Valid.class);
        startActivity(ob);
    }
}