...
public class A_1_Teach extends AppCompatActivity {
    Button ochoo;
    MediaPlayer mp3;
        ...
        ochoo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mp3.isPlaying()){
                    ...
                    Toast.makeText(A_1_Teach.this,"Pausa",Toast.LENGTH_SHORT).show();
                }else{
                    mp3.start();
                    ochoo.setBackgroundResource(R.drawable.play);
                    Toast.makeText(A_1_Teach.this,"Play",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    public void draw(View view) {
        Intent ob = new Intent(A_1_Teach.this, A_1_Paint.class);
        startActivity(ob);
    }
}