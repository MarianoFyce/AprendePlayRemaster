...
public class A_2_Paint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.doss));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(A_2_Paint.this,"¡Imagen Guardada!",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
*/
    ...
    public void pasavalidar(View view) {
        Intent ob = new Intent(A_2_Paint.this, A_2_Valid.class);
        startActivity(ob);
    }
}