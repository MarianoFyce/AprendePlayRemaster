...
public class A_6_Paint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a6_paint);

        ////////////parte del video
        videoView = findViewById(R.id.videoocho);

        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.seiss));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(A_6_Paint.this,"¡Imagen Guardada!",Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
...
*/
    ...
    public void pasavalidar(View view) {
        Intent ob = new Intent(A_6_Paint.this, A_6_Valid.class);
        startActivity(ob);
    }
}