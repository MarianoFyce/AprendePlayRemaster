...
public class ChatAdapterd extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final List<ChatMensajed> ChatMensajes;
    ...
    public ChatAdapterd(List<ChatMensajed> ChatMensajes, Bitmap receivedPerfilImagen, String senderId) {
...
if (getItemViewType(position) == VIEW_TYPE_SENT){
    ...
    static  class SentMensajeView extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMensajed chatMensaje){
    ...
    static class ReceivedMensajeViewh extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMensajed chatMensaje, Bitmap receiverPerfilImagen){
