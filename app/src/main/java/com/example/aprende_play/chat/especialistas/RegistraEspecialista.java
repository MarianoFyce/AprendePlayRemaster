...
import com.example.aprende_play.databinding.ActivityRegistraEspecialistaBinding;
...
public class RegistraEspecialista extends AppCompatActivity {
    private ActivityRegistraEspecialistaBinding binding;
    private  String encodedImage;
    private PreferenceManager preferenceManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityRegistraEspecialistaBinding.inflate(getLayoutInflater());
    ...
    private void signUp(){
        ...
        database.collection(DatosTutores.KEY_COLLECTION_ESPE)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    Intent intent = new Intent(getApplicationContext(), Logespecial.class);
