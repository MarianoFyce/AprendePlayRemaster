...
import com.example.aprende_play.databinding.ActivityVerninossBinding;
...
public class Verninoss extends BaseActivity implements Userlisteners {
    private ActivityVerninossBinding binding;
    private PreferenceManager preferenceManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityVerninossBinding.inflate(getLayoutInflater());
    ...
    public void sig(View view) {
        Intent intent  = new Intent(getApplicationContext(), Registrarninos2.class);
        startActivity(intent);
    }
}